...
@section('container_section')
    <div class="page-hero bg-image overlay-dark" style="background-image: url({{ url('/') }}/template_home/img/bg_image_1.jpg);">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6 wow fadeInRight" data-wow-delay="400ms">
            <div class="img-place custom-img-1">
              <img src="{{ url('/') }}/template_home/img/bg-doctor.png" alt="">
            </div>
          </div>
        </div>
      </div>
